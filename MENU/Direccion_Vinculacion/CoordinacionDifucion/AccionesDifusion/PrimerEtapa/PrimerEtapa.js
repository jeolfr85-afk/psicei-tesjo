document.addEventListener('DOMContentLoaded', () => {
    ...
    const encabezados = [
        ...
        "MUNICIPIO",
        "FECHA",
        "NÚMERO DE ESTUDIANTES PROMOCIONADOS",
    ...
    function agregarFila() {
        ...
        encabezados.forEach((enc, index) => {
            ...
            // Columna FECHA con calendario
            if(index === 4){
                const inputDate = document.createElement('input');
                inputDate.type = 'date';
                inputDate.addEventListener('keydown', moverTeclasInput);
                td.appendChild(inputDate);
            } else {
                td.contentEditable = true;
                td.addEventListener('keydown', moverTeclas);
                td.addEventListener('input', actualizarTotales);
            }
