// Datos base
const secciones = [
  { titulo: "Software Usado", categorias: ["NOMBRE", "CATEGORÍA (SISTEMAS OPERATIVOS, ANTIVIRUS, OFIMÁTICA, ETC.)", "NÚMERO DE LICENCIAS"] },
  { titulo: "Software Desarrollado", categorias: ["NOMBRE", "CATEGORÍA (PROGRAMAS, SISTEMAS ADMINISTRATIVOS, MANTENIMIENTO, ETC.)", "NÚMERO DE LICENCIAS"] }
];

const subgrupos = ["TES JOCOTITLÁN", "EXTENSIÓN ACULCO"];
