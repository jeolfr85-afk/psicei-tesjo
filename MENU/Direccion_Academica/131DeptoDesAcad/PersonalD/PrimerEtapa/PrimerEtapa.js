document.addEventListener('DOMContentLoaded', () => {
    ...
    const encabezados = [
        "NOMBRE",
        "SEXO",
        "NIVEL QUE ESTUDIA (ESPECIALIDAD, MAESTRÍA, DOCTORADO)",
        "LUGAR DONDE ESTUDIA MÉXICO (ENTIDAD FEDERATIVA), PAÍS",
        "BECA",
        "DURACIÓN",
        "PERIODO (INICIO - TERMINO)",
        "TIPO DE CURSO (FORMACIÓN, SUPERACIÓN, ACTUALIZACIÓN)",
        "CON DISCAPACIDAD",
        "HABLANTES DE LENGUAJES INDIGENAS ",
        "PROGRAMA ACADÉMICO"
    ];
